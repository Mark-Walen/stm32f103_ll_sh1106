...
{
	printf("%.2x\r\n", IIC_Read_Byte(MAX30102_Device_address, 0xFF));
...
uint8_t get_fifo_size(void)
{
	uint8_t read_ptr, write_ptr;
	int8_t tmp;
	
	write_ptr = IIC_Read_Byte(MAX30102_Device_address, REG_FIFO_WR_PTR);
	read_ptr = IIC_Read_Byte(MAX30102_Device_address, REG_FIFO_RD_PTR);
